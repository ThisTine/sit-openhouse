...
const Cs_Dday = () => {
	return (
		<div className="grid gap-8">
			...
			<p>CS Project D-Day Exhibition 2023 งานแสดงผลงานด้านเทคโนโลยีและวิทยาการคอมพิวเตอร์ ของ นศ.ชั้นปีที่ 4 สาขาวิชาวิทยาการคอมพิวเตอร์ (หลักสูตรภาษาอังกฤษ) โดยจัดแสดงผลงานทั้งหมด 16 กลุ่ม </p>
