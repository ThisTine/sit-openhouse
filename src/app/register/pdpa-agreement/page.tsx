	...
	return (
		<div style={{ backgroundColor: "#34312F" }}>
			<div className="p-5">
				...
				<div>
					<h2 className="my-5 text-xl text-primary">
            หนังสือยินยอมเพื่อขอใช้ประโยชน์ ข้อมูลส่วนบุคคล
					</h2>
				...
				<div className="my-5 flex flex-col gap-5">
					<Button className="h-12" fullWidth variant="outlined">
            ย้อนกลับ
					</Button>
					<Button className="h-12 bg-primary" variant="contained">
            ยอมรับและยื่นยันการลงทะเบียน
					</Button>
				</div>
			</div>
		</div>
