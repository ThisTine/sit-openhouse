		...
		<div style={{backgroundColor:"#34312F",minHeight:"100vh"}} >
			<div className="m-auto max-w-screen-2xl p-5">
				...
				<div className="my-5 flex flex-col gap-5  md:flex-row md:justify-between">
					...
					<Button className="h-12 bg-primary" onClick={()=>setPage(registerPage.openHousePage)} variant="contained">ยอมรับและยืนยันการลงทะเบียน</Button>
				</div>
			</div>
		</div>);
};
export default PDPAagreementPageOPH;
