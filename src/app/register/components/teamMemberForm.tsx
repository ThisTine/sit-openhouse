...
const TeamMemberForm = ({ prefix, grade }: IteamMemberFormProps) => {
	...
	const {
		...
		resolver: yupResolver(ICTFormMemberSchema),
		defaultValues: {
			prefixMember: "",
			memberName: "",
			memberSurName: "",
	...
	return (
		<div>
			<h2 className="text-primary text-lg">สมาชิกในทีม</h2>
			<div className="my-3">
				<div className="flex gap-4">
					<div
						className={
							member == 1
								? "bg-primary rounded-lg p-2 text-white opacity-100"
								: "bg-primary rounded-lg p-2 text-white opacity-50"
						}
					>
            คนที่ 1
					</div>
			...
			<div>
				<h2 className="text-primary text-base">ช่องทางการติดต่อ</h2>
				<div className="grid grid-cols-6 gap-4">
			...
			<div className="my-5 flex justify-between">
				<Button onClick={handleMemeberBack} variant="outlined">
          ย้อนกลับ
				</Button>
				<Button
