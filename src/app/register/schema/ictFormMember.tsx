...
const ICTFormMemberSchema : ObjectSchema<ICTChallangeMemberForm>  = object().shape({
	...
	facebookMember : string().required("กรุณาใส่เฟสบุ๊ค"),
	lineMember : string().required("กรุณาใส่ไลน์")
